 ...
 * BaziComputer
 */
function BaziComputer(year, month, day, hour, dtype, mtype) {
  if (hour < 0 || hour > 23) {
  ...
  this._day = day;
  this._hour = hour;
  this._chineseDate = chineseDateUtils.buildChineseDate(year, month, day, dtype, mtype == 1);
...
module.exports = function (ctx, next) {
  ...
  let bazi = new BaziComputer(date.getFullYear(), date.getMonth() + 1, date.getDate(), date.getHours(), ctx.request.body.index, ctx.request.body.yindex);
